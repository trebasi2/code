...
x2=input().split()
x2=[(i) for i in x2]
if x[0]==x[1]==x[2]=="x" or x1[0]==x1[1]==x1[2]=="x" or x2[0]==x2[1]==x2[2]=="x" or x[0]==x1[0]==x2[0]=="x" or x[1]==x1[1]==x2[1]=="x" or x[2]==x1[2]==x2[2]=="x" or x[0]==x1[1]==x2[2]=="x" or x[2]==x1[1]==x2[0]=="x":
    print("Player [x] win!")
